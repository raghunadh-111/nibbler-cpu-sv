...
HD_PWD='D:/Vivado/NibblerCPU_3p5mhz/NibblerCPU_3p5mhz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nibbler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nibbler.tcl
