...
HD_PWD='D:/Vivado/NibblerCPU_3p5mhz/NibblerCPU_3p5mhz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nibbler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nibbler.tcl -notrace
