create_clock -period 200 -name nibbler_clk -waveform {0.000 100.000} [get_ports {clk}];
...
#set_disable_timing -from I0 -to O \dataBus_OBUFT[3]_inst_i_1
#set_disable_timing -from I0 -to O \ffOut_OBUFT[0]_inst_i_1
#set_disable_timing -from I1 -to O \aluResult_OBUF[2]_inst_i_9
#set_disable_timing -from I0 -to O \ffOut_OBUFT[1]_inst_i_1
#set_disable_timing -from I0 -to O \ffOut_OBUFT[2]_inst_i_1
